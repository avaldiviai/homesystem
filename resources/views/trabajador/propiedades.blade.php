                    ...
                    <div class="row scrol">
                        @foreach ($propiedades as $propiedad)
                            <div class="col-lg-3 mb-3">
                                <a href="propiedadesDetallestrabajador-{{$propiedad->id}}" style="text-decoration:none; color: #000;">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content modal-xl">
                ...
                <div class="modal-body ">
                    <form id="arriendoForm" action="{{ url('/trabajador/propiedades') }}" method="POST" enctype="multipart/form-data" id="form-arriendo">
                        @csrf
                        <div class="container ">
    ...
    @section('javascript')
        ...
        $("#btn_agregar").on('click', function(event){
            ...
            console.log('todo correcto');
                ...
                $.ajax({
                    url: '{{ url('/trabajador/propiedades') }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
