                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12" style="text-align: start; margin-top: 40px; margin-bottom: 20px; margin-start: 30px; color: white;">
                            <h1 class="text-uppercase text-black">Propiedades Marzo a Diciembre</h1>
                        </div>
                    ...
                    <div class="row scrol">
                        @foreach ($propiedades as $propiedad)
                            <div class="col-lg-3 mb-3">
                                <a href="propiedadesDetallesObrero-{{$propiedad->id}}" style="text-decoration:none; color: #000;">
                                    <div class="card position-relative registro shadow tarjeta-propiedad" style="border:none;">
                                        ...
                                        @if($imagen)
                                            <img src="{{ asset($imagen->link) }}" class="card-img-top img-fluid imagen-tarjeta" style="height: 200px; object-fit: cover;" alt="{{ $propiedad->direccion }}" data-imagen-url="{{ asset($imagen->link) }}">
                                        @else
                                            <img src="{{ asset('img/OIP.jpg') }}" class="card-img-top img-fluid imagen-tarjeta" style="height: 200px; object-fit: cover;" alt="Imagen no disponible" data-imagen-url="{{ asset('images/default-image.png') }}">
                                        @endif
                                        ...
                                        <div class="position-absolute end-0 p-1 d-flex flex-column botones-propiedad" style="background: rgba(0, 0, 0, 0.63); top: 60px;">
    ...
    <div class="modal fade" id="agregarPropiedad" tabindex="-1" data-bs-backdrop="static" tabindex="-1"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content modal-xl">
                ...
                <div class="modal-body ">
                    <form id="arriendoForm" action="{{ url('/obrero/propiedades') }}" method="POST" enctype="multipart/form-data" id="form-arriendo">
                        @csrf
                        <div class="container ">
        ...
        <div class="modal fade" id="Detalle_Propiedad" tabindex="-1" data-bs-backdrop="static" tabindex="-1"
            ...
            <div class="modal-dialog modal-xl">
                ...
                <div class="modal-body ">
                    <form id="arriendoForm" action="{{ url('/obrero/detallespropiedad') }}" method="POST"
                                ...
                                <div class="col-12 col-md-6 p-3 " >
                                    <div class="row g-3 m-1 shadow" style="background-color: #FFE2B2; border-radius: .9rem;">
                                        ...
                                        <div class="form-group col-12 col-lg-6">
                                            ...
                                            <input type="number" class="form-control" id="baños" name="banos" placeholder="Ej: 1">
                                        </div>
                                    </div>
                                </div>
...
<style>
    ...
    scrollbar-color:rgb(114, 114, 114) #f8f9fa; /* Color del scroll (primero: barra, segundo: fondo) */
    }
    ...
    @section('javascript')
        ...
        <script>
            ...
            $("#confimarventa").click(function(event){
                ...
                $.ajax({
                    url: '/obrero/venderpropiedad' + idPropiedad,
                    type: 'POST',
                    data: idPropiedad,
                    dataType: 'json',
            ...
            function actualizarLista() {
                ...
                $.each(PropietariosAgregados, function(index, propietarios) {
                    ...
                    $.ajax({
                        url: '/obrero/obtener/propietarioNombre',
                        type: 'GET',
                                ...
                                $("<div>")
                                    ...
                                    .append(
                                        $("<button>")
                                            ...
                                            .addClass("btn btn-sm btn-link p-0") // Botón pequeño y minimalista
                                            .on("click", function () {
                    ...
                    inputFile.onchange = function(event) {
                        ...
                        if (file) {
                            ...
                            $.ajax({
                                ...
                                url: '{{ url('/obrero/imagen/cambiar + ImagenId ') }}',
                                type: 'POST',
                                data: formData,
    ...
    location.reload();
                ...
                $(".borrar-propiedad-btn").on('click', function(event) {
                    ...
                    $("#confirmDelete").off('click').on('click', function() { // Usar off() para evitar múltiples bindings
                        ...
                        // Realizar la solicitud AJAX
                        $.ajax({
                            url: `/obrero/propiedad/${idPropiedad}`, // Usar template literals para construir la URL
                            type: 'DELETE',
                            dataType: 'json',
                            headers: {
            ...
            $(document).ready(function() {
                ...
                $('#btn_agregardetalle').on('click', function(e) {
                    ...
                    var ano_construccion = $("#AñocoInput").val();
                    var piso = $("#piso").val();
                    ...
                    $.ajax({
                        url: '/obrero/detallespropiedad/' + id_propiedad, // URL de la ruta definida
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
            ...
            $(document).ready(function () {
                ...
                $("#guardar-mantenciones").on('click', function (event) {
                    ...
                    if (MantencionesAgregadas.length > 0) {
                        $.ajax({
                            url: '/obrero/guardar/mantenciones', // Ruta del backend para guardar
                            type: 'POST',
                            data: {
            ...
            $(".btn-Contrato").on('click', function(event) {
                ...
                $.ajax({
                        url: '/obrero/mostrar/archivo/' + id_propiedad,
                        type: 'GET',
                        dataType: 'json'
                    })
                ...
                document.getElementById('agregar-datossolo').addEventListener('click', function() {
                    ...
                    $(document).ready(function() {
                        ...
                        $('#confirmarEliminarContratoBtn').on('click', function() {
                            // Realizar la solicitud AJAX
                            $.ajax({
                                url: '/obrero/elimiarchivo/' + archivoId,
                                type: 'DELETE',
                                data: {
                                    _token: '{{ csrf_token() }}'
                                },
