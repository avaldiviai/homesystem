        ...
        <div class="col">
            <div class="container-fluid">
                <div class="row overflow-auto" style="max-height: 100vh;">                      
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-4">
                                        ...
                                        <select name="arrendatarioInput" id="arrendatarioInput">
                                            ...
                                            @endforeach
                                            <option value="nuevo_arrendatario">Agregar Nuevo</option> <!-- Cambia este valor -->
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3 col-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="text" class="form-control" id="valorArriendoAñocorridoInput" value="{{$precios->ano_corrido}}"
                                                placeholder="Ej: $460.000" required readonly>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-12 p-4">
                        <div class="row p-3 shadow mt-2 text-white"style="background-color: #E67E22; border-radius: .9rem;">
                            ...
                            <div class="col-lg-12 text-end">
                                ...
                                <!-- <button type="button" class="btn btn-success" id="guardar-mantenciones">Guardar Mantenciones Agregadas</button> -->
                            </div>
                                    ...
                                    @foreach($mantenimiento as $mante)
                                        <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ asset('storage/public/' . $mante->doc) }}" target="t_blank" download class="btn btn-primary ms-2">
                    ...
                    <div class="col-lg-6 p-4">
                        <div class="row p-3 shadow text-white"style="background-color:#E67E22; border-radius: .9rem;height:490px;">
                            <div class="col-lg-12">
                                <div class="col-lg-6 bg-black rounded-pill shadow text-white text-center">
                    ...
                    <div class="col-lg-6 p-4">
                        <div class="row shadow p-2 text-white" style="background-color:#E67E22; border-radius: .9rem;">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <!-- <input type="text" id="agua_caliente_edit" class="form-control" value="{{$detallespropiedad->agua_caliente}}" > -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 p-4">
                    ...
                    <div class="col-lg-12 mb-3 mt-3 d-flex justify-content-end">
                        <a href="/proanocorrido" class="btn btn-danger m-1">Volver</a>
                        <button class="btn btn-primary m-1"data-id="{{$detalles->id}}" id="guardarCambios">Guardar Edicion</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#guardarCambios').off().on('click', function(event) {
        ...
        $.ajax({
            url: '/obrero/editarDetalles', // Cambia por la URL del controlador en Laravel
            type: 'POST',
            datatype:'json',
            data: formData,
            processData: false,
    ...
    $(".delete-img").on('click', function() {
        ...
        $("#confirmDelete").on('click', function() { // Usar off() para evitar múltiples bindings
            ...
            // Realizar la solicitud AJAX
            $.ajax({
                url: '/obrero/imagen/' + idImg, // Usar template literals para construir la URL
                type: 'DELETE',
                datatype: 'json',     
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $("#close_success").click(function() {
        ...
        $("#confirmDelete").on('click', function() { // Usar off() para evitar múltiples bindings
            ...
            // Realizar la solicitud AJAX
            $.ajax({
                url: '/obrero/mantencion/' + id_mantencion, // Usar template literals para construir la URL
                type: 'DELETE',
                datatype: 'json',     
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(".delete-video").on('click', function() {
        ...
        $("#confirmDelete").off().on('click', function() { // Usar off() para evitar múltiples bindings
            ...
            // Realizar la solicitud AJAX
            $.ajax({
                url: '/obrero/video/' + idVideo, // Usar template literals para construir la URL
                type: 'DELETE',
                datatype: 'json',     
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(".portada").on('click', function(event) {
        ...
        $("#confirmCambio").on('click', function() {
            // Consulta a AJAX
            $.ajax({
                url: '/obrero/portada/cambiar_img/' + idImg,
                type: 'POST',
                datatype: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(document).ready(function () {
        ...
        $("#agregar-mantencion").on('click', function (e) {
            ...
            $.ajax({
                url: '/obrero/guardar/mantenciones',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
    ...
    $(".delete-propietario").on('click', function() {
        ...
        $("#confirmDelete").on('click', function() { // Usar off() para evitar múltiples bindings
            ...
            // Realizar la solicitud AJAX
            $.ajax({
                url: '/obrero/propietarioDelete/' + idPropietario, // Usar template literals para construir la URL
                type: 'DELETE',
                datatype: 'json',     
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
