            ...
            <div class="flex-grow-1">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center" style="margin-top: 40px;">
                        <div class="col-6 text-uppercase" style="margin-bottom: 20px; margin-left: 30px; color: black; text-align: start;">
                            <h1>Inventario</h1>
                        </div>
                        <div class="container-fluid">
...
<style>
    ...
    overflow-y: auto;
    overflow-x: auto;
    border: 1px solid #ccc; /* Opcional, solo para visualizar el área */
}
...
<script>
    $(document).ready(function() {
        ...
        window.agregarInventario = function() {
            ...
            const url = window.location.pathname.includes('/trabajador') ? '/trabajador/inventario' : '/inventario';
