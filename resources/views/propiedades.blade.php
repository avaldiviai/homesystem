                    ...
                    <div class="row scrol">
                        @foreach ($propiedades as $propiedad)
                            <div class="col-lg-3 mb-3">
                                <a href="propiedadesDetalles-{{$propiedad->id}}" style="text-decoration:none; color: #000;">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content modal-xl">
                ...
                <div class="modal-body ">
                    <form id="arriendoForm" action="{{ url('/propiedades') }}" method="POST" enctype="multipart/form-data" id="form-arriendo">
                        @csrf
                        <div class="container ">
                            <div class="row mb-3 p-4 shadow" style="background-color: #FFE2B2; border-radius: .9rem;">
                                ...
                                <div class="form-group col-lg-4">
                                    <label for="TorrenumeroInput">N° de Departamento</label>
