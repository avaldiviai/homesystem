    ...
    <aside class="bg-white shadow-lg rounded-4"  id="menuContainer" style="min-height: 70vh;">
        <nav class="nav flex-column py-4 px-1" style="font-size: 16px;">
            ...
            <div class="collapse d-lg-block" id="responsiveMenu">
                ...
                <li class="nav-item mb-3">
                    ...
                    <div class="collapse rounded show" id="propiedades">
                        <ul class="nav flex-column ms-3 mt-2">
                            <li class="nav-item">
                                <a href="/trabajador/propiedades" class="nav-link"><i class="fa-solid fa-building me-2 text-warning"></i> Pro. Marzo a Dic.</a>
                            </li>
                            <li class="nav-item">
                                <a href="/trabajador/proanocorrido" class="nav-link"><i class="fa-solid fa-building me-2 text-warning"></i> Pro. Año Corrido</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item mb-3">
                    <a class="nav-link d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#arriendos" role="button" aria-expanded="true" aria-controls="arriendos">
                        <span><i class="fa-solid fa-key me-2 text-warning"></i> Gestión de Arriendos</span>
                        <i class="fa-solid fa-chevron-down text-muted"></i>
                    </a>
                    <div class="collapse show" id="arriendos">
                        <ul class="nav flex-column ms-3 mt-2">
                            <li class="nav-item"><a href="/trabajador/arriendos" class="nav-link"><i class="fa-solid fa-key me-2 text-warning"></i> Arriendos</a></li>
                            <li class="nav-item"><a href="/trabajador/elementos" class="nav-link"><i class="fa-solid fa-boxes me-2 text-warning"></i> Elementos</a></li>
                            <li class="nav-item"><a href="/trabajador/inventario" class="nav-link"><i class="fa-solid fa-cart-flatbed me-2 text-warning"></i> Inventario</a></li>
                        </ul>
                    </div>
                </li>
