                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-4 text-end">
                                <button type="button" class="btn btn-success shadow " data-bs-toggle="modal"
                                    data-bs-target="#agregarPropiedad">
                        ...
                        <div class="row scrol">
                            @foreach ($propiedades as $propiedad)
                                <div class="col-lg-3 mb-3">
                                    <a href="proanocorridopropiedadesDetalles-{{ $propiedad->id }}"
                                        style="text-decoration:none; color: #000;">
                                        <div class="card position-relative registro shadow tarjeta-propiedad"
                                            style="border:none;">
                                            @php
                                                // Obtener la primera imagen de la propiedad
                                                $imagen = $propiedad->imagenes->first();
                                                $subdetalles = \App\Models\SubDetalles::where(
                                                    'id_propiedad',
                                                    $propiedad->id,
                                                )->first();
                                                $propietario = \App\Models\Propietario_propiedades::where(
                                                    'id_propiedad',
                                                    $propiedad->id,
                                                )->first();
                                            ...
                                            @else
                                                <img src="{{ asset('img/OIP.jpg') }}" class="card-img-top img-fluid"
                                                    style="height: 200px; object-fit: cover;" alt="Imagen no disponible"
                                            ...
                                            <div class="texto-propiedad position-absolute bottom-0 start-0 w-100 text-white p-3"
                                                ...
                                                @if ($propietario && $propietario->propietario)
                                                    <h6 class="detalles"><strong>Propietario:</strong>
                                                        {{ $propietario->propietario->nombre }}</h6>
                                                @else
                                                    <h6 class="detalles"><strong>Propietario:</strong> Sin propietario</h6>
                                                @endif
                                                <h6 class="detalles"><strong>Condominio:</strong>
                                                    {{ $propiedad->condominio }}</h6>
                                                <h6 class="detalles"><strong>N° Dpto:</strong> {{ $propiedad->num_torre }}
                                                </h6>
                                                @if ($subdetalles)
                                                    <h6 class="detalles"><strong>N° Estacionamiento:</strong>
                                                        {{ $subdetalles->estacionamiento }}</h6>
                                                @endif
                                            </div>
                                            <div class="position-absolute top-0 p-2 d-flex flex-column">
                                                @if ($propiedad->estado_venta == 2)
                                                    <a class="btn btn-primary estado-propiedad"
                                            ...
                                            <div class="position-absolute end-0 p-1 d-flex flex-column "
                                                ...
                                                @if ($detallePropiedad && $detallePropiedad->ano_construccion === null)
                                                    <a href="#" class="text-primary mb-2 detalle-propiedad-btn mt-2"
                                                ...
                                                <a href="#" class="text-success mb-2 btn-Contrato"
                                                    data-id="{{ $propiedad->id }}" title="Agregar Archivo">
                                                    <i class="fa-regular fa-folder fa-lg"></i>
                                                </a>
                                                <a href="#" class="text-warning mb-2 btn-mantencion"
                                                    data-id="{{ $propiedad->id }}" title="Mantencion">
                                                    <i class="fa-solid fa-screwdriver-wrench"></i>
                                                </a>
                                                <a href="#" class="text-danger borrar-propiedad-btn mb-1"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content modal-xl">
                ...
                <div class="modal-body ">
                    <form id="arriendoForm" action="{{ url('/proanocorrido') }}" method="POST"
                        ...
                        <div class="container ">
                            <div class="row mb-3 p-4 shadow" style="background-color: #FFE2B2; border-radius: .9rem;">
                                ...
                                <div class="form-group col-lg-4 mt-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="AnoCorridoInput"
                                            placeholder="Precio Año Corrido" oninput="formatearMiles(this)" required>

                                        <span class="input-group-text fw-bold text-dark bg-light">
                                            CLP
                                        </span>
                                    </div>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="rolInput" placeholder="Ej: 123-456"
                                        required>
                                </div>
                                <div class="form-group col-lg-4">
                            ...
                            <div class="row mb-3 p-4 mb-2 shadow"
                                ...
                                <div class="form-group col-lg-6 text-center">
                                    ...
                                    <div class="mt-2">
                                        <input type="radio" name="estacionamientoCheck" id="estacionamientoSi"
                                            value="si">
                                        <label for="estacionamientoSi">Sí</label>
                                        <input type="radio" name="estacionamientoCheck" id="estacionamientoNo"
                                            value="no">
                                    ...
                                    <div id="camposEstacionamiento" class="form-group col-lg-12" style="display: none;">
                                        <div class="row bg-white m-1" style="border-radius: .9rem;">
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                <input type="text" class="form-control mt-2" id="montoInput"
                                                    placeholder="Monto">
                                            </div>
                                            <div class="form-group col-lg-4">
                                                <label for="rolInputest">Rol</label>
                                                <input type="text" class="form-control mt-2" id="rolInputest"
                                                    placeholder="Rol">
                                            </div>
                                            <div class="form-group col-lg-4">
                                            ...
                                            <div class="form-group col-lg-12 text-center">
                                                ...
                                                <div class="mt-2">
                                                    <input type="radio" name="techadoCheck" id="techadoSi"
                                                        value="1">
                                                    <label for="techadoSi">Sí</label>
                                                    <input type="radio" name="techadoCheck" id="techadoNo"
                                                        value="0">
                                ...
                                <div class="col-lg-4 p-3">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input bg-primary border-primary" type="checkbox"
                                            id="toggleColumns">
                                        <label class="form-check-label" for="toggleColumns">Agregar Imagenes y
                                            Videos</label>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content modal-xl">
                <div class="modal-header" style="background-color: #FFE2B2; justify-content: center; position: relative;">
                    <h5 class="modal-title text-uppercase" id="Detalle_PropiedadLabel">Agregar Detalles a la Propiedad
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        style="position: absolute; right: 10px; top: 10px;"></button>
                </div>
                <div class="modal-body ">
                    <form id="arriendoForm" action="{{ url('/detallespropiedad') }}" method="POST"
                        enctype="multipart/form-data" id="form-arriendo">
                        @csrf
                        <div class="container">
                            <!-- Campos de entrada -->
                                    ...
                                    <div class="row g-3 m-1 shadow"
                                        ...
                                        <div class="form-group col-12 col-lg-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="dormitorios"
                                                name="dormitorios" placeholder="Ej: 2">
                                        </div>
                                        <div class="form-group col-12 col-lg-6 mb-3">
                            ...
                            <div class="row g-3 m-1 shadow mb-4" style="background-color: #FFE2B2; border-radius: .9rem;">
                                <div class="form-group mb-3 col-lg-4">
                                    ...
                                    <input type="number" class="form-control" id="mt2_construido" name="mt2_construido"
                                        placeholder="Ej: 80">
                                </div>
                                <div class="form-group mb-3 col-lg-4">
                                    <label for="mt2_terraza" class="form-label">MT2 de Terraza</label>
                                    <input type="number" class="form-control" id="mt2_terraza" name="mt2_terraza"
                                        placeholder="Ej: 20">
                                </div>
                                <div class="form-group mb-3 col-lg-4">
                                    <label for="mt2_total" class="form-label">MT2 Total</label>
                                    <input type="number" class="form-control" id="mt2_total" name="mt2_total"
                                        placeholder="Ej: 100">
                                </div>
                                <div class="form-group mb-3 col-lg-5">
                                    <label for="inventario" class="form-label">Inventario</label>
                                    <textarea type="text" class="form-control" id="inventario" name="inventario"
                                        placeholder="Ej: muebles incluidos"></textarea>
                                </div>
                                ...
                                <div class="form-group mb-3 col-lg-4 text-center">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="estacionamiento_visitas_si"
                                                name="estacionamiento_visitas" value="1">
                                            <label class="form-check-label" for="estacionamiento_visitas_si">Sí</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="estacionamiento_visitas_no"
                                                name="estacionamiento_visitas" value="0">
                            ...
                            <div class="row g-3 m-1 shadow" style="background-color: #FFE2B2; border-radius: .9rem;">
                                <div class="form-group mb-3 col-lg-3 col-sm-4 text-center">
                                    ...
                                    <div>
                                        <input type="radio" id="espacio_lavadora" name="espacio_lavadora"
                                            value="1
                                        ">
                                        <label for="espacio_lavadora">Sí</label>
                                        <input type="radio" id="espacio_lavadora_no" name="espacio_lavadora"
                                            value="0">
                                ...
                                <div class="form-group mb-3 col-lg-3 col-sm-4 text-center">
                                    ...
                                    <div>
                                        <input type="radio" id="lavadora" name="lavadora"
                                            value="1
                                        ">
                                ...
                                <div class="form-group mb-3 col-lg-3 col-sm-4 text-center">
                                    ...
                                    <div>
                                        <input type="radio" id="juegos_infantiles_si" name="juegos_infantiles_si"
                                            value="1
                                        ">
                                        <label for="juegos_infantiles_si">Sí</label>
                                        <input type="radio" id="juegos_infantiles_no" name="juegos_infantiles_no"
                                            value="0">
                                ...
                                <div class="form-group mb-3 col-lg-3 col-sm-4 text-center">
                                    ...
                                    <div>
                                        <input type="radio" id="lavanderia_si" name="lavanderia"
                                            value="1
                                        ">
                                ...
                                <div class="form-group mb-3 col-lg-3 col-sm-4 text-center">
                                    ...
                                    <div>
                                        <input type="radio" id="quinchos_si" name="quinchos"
                                            value="1
                                        ">
                                ...
                                <div class="form-group mb-3 col-lg-3 col-sm-4 text-center">
                                    ...
                                    <div>
                                        <input type="radio" id="sala_multiuso_si" name="sala_multiuso"
                                            value="1
                                        ">
                                ...
                                <div class="form-group mb-3 col-lg-3 col-sm-4 text-center">
                                    ...
                                    <div>
                                        <input type="radio" id="gimnasio_si" name="gimnasio"
                                            value="1
                                        ">
                                ...
                                <div class="form-group mb-3 col-lg-4 col-sm-4 text-center">
                                    ...
                                    <div>
                                        <input type="radio" id="ciclovia_si" name="ciclovia"
                                            value="1
                                        ">
                ...
                <div class="modal-body">
                    <div class="container">
                        <div id="mantencionesContainer">
                            <div class="row p-2 mantencion-item"
                                style="background-color: #FFE2B2; border-radius: .9rem; margin-bottom: 10px;">
                                <div class="col-lg-6 mb-3">
                                    <label for="nombremantenimiento">Nombre del Mantenimiento</label>
                                    <input type="text" class="form-control " id="nombremantenimiento"
                                        placeholder="Ingrese el nombre del mantenimiento" required>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <label for="descripcionmantenimiento">Descripción</label>
                                    <textarea class="form-control " id="descripcionmantenimiento" placeholder="Ingrese la descripción del mantenimiento"
                                        required></textarea>
                                </div>
                                <div class="col-lg-6 mb-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="number" class="form-control " id="cadamantenimiento"
                                        placeholder="Ingrese la cantidad de meses para la mantención" required>
                                </div>
                                <div class="col-lg-12 text-end">
                                    <button type="button" class="btn btn-primary" id="agregar-mantencion">Agregar
            ...
            <div class="alert alert-success d-flex align-items-center" id="alerta" role="alert">
                <div class="modal-content" style="background-color: rgb(0,0,0,0.0); border:none">
                    <h5 class="m-4 text-uppercase text-center">¿Seguro/a que quieres Arrendar esta Propiedad?</h2>
                        <div class="modalfooter d-flex justify-content-center">
                            <button type="button" class="btn btn-danger m-2" data-bs-dismiss="modal">Cancelar</button>
                            <button type="button" id="confimarventa" class="btn btn-success m-2">Arrendar</button>
                        </div>
                </div>
            </div>
        </div>
...
@section('css')
    <style>
        .scrol {
            ...
            scrollbar-color: rgb(105, 101, 101) #f8f9fa;
...
@section('javascript')
                    ...
                    success: function(response) {
                        ...
                        var listItem = $("<div>")
                            .append(
                                $("<div>")
                                .addClass(
                                    "bg-white p-2 rounded d-flex align-items-center justify-content-between w-100 mb-1"
                                )
                                .append(
                                    $("<span>")
                                    .html('<i class="fa-solid fa-user-tie me-2"></i>' + response
                                        .nombre) // Texto con ícono
                                )
                                .append(
                                    $("<button>")
                                    .html(
            ...
            inputFile.onchange = function(event) {
                ...
                if (file) {
                    ...
                    $.ajax({
                        ...
                        url: '{{ url('/imagen/cambiar + ImagenId ') }}',
                        type: 'POST',
                        data: formData,
    ...
    `);
                ...
                formData.append(
                    ...
                    JSON.stringify(PropietariosAgregados)
                );
                    ...
                    error: function(xhr, status, error) {
                        ...
                        if (status === 'timeout') {
                            ...
                            Swal.fire({
                                ...
                                text: 'La subida demoró demasiado. Verifique su conexión e intente nuevamente.'
                            });
        ...
        $(".borrar-propiedad-btn").on('click', function(event) {
            ...
            $("#confirmDelete").off('click').on('click', function() { // Usar off() para evitar múltiples bindings
                ...
                $.ajax({
                    url: `/propiedad/${idPropiedad}`, // Usar template literals para construir la URL
                    type: 'DELETE',
                    dataType: 'json',
                    headers: {
        ...
        $(document).ready(function() {
            ...
            $('#btn_agregardetalle').on('click', function(e) {
                ...
                if (camposVacios) {
                    ...
                    $.ajax({
                        url: '/detallespropiedad/' + id_propiedad, // URL de la ruta definida
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
        ...
        $(document).ready(function() {
            ...
            function actualizarListaMantenciones() {
                ...
                MantencionesAgregadas.forEach(function(mantencion, index) {
                    ...
                    var proximaFecha = new Date(fechaInicial.setMonth(fechaInicial.getMonth() + parseInt(
                        mantencion.meses)));
