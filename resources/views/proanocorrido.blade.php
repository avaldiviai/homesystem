                    ...
                    <div class="row scrol">
                        @foreach ($propiedades as $propiedad)
                            <div class="col-lg-3 mb-3">
                                <a href="proanocorridopropiedadesDetalles-{{$propiedad->id}}" style="text-decoration:none; color: #000;">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content modal-xl">
                ...
                <div class="modal-body ">
                    <form id="arriendoForm" action="{{ url('/proanocorrido') }}" method="POST" enctype="multipart/form-data" id="form-arriendo">
                        @csrf
                        <div class="container ">
                            <div class="row mb-3 p-4 shadow" style="background-color: #FFE2B2; border-radius: .9rem;">
                                ...
                                <div class="form-group col-lg-4 mt-3">
                                    <label for="AnoCorridoInput">Precio Año Corrido</label>
                                        <label for="AnoCorridoInput" class="form-label">Precio Año Corrido</label>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="TorrenumeroInput" placeholder="Numero del Departamento" required>
                                </div>
                                <div class="form-group col-lg-4">
