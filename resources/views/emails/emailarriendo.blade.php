...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <h1>¡Pago con Retraso!</h1>
        </div>
        
        <!-- Content Section -->
        <div class="email-content">
            <h3 class="section-title">Detalles del Pago</h3>
            <p><span class="highlight">Valor del Arriendo:</span> ${{ $valor_real }}</p>
            <p><span class="highlight">Fecha de Pago:</span> {{ $fecha_pago }}</p>
            <p><span class="highlight">Dias de Retraso:</span> {{ $diasAtraso }}</p>
        </div>
        
        <div class="email-content">
            <h3 class="section-title">Detalles de la Propiedad</h3>
            <p><span class="highlight">Condominio:</span> {{ $condominio }}</p>
        ...
        <div class="email-footer">
            <p>Este es un correo automático enviado debido al retraso de su pago de arriendo. Por favor, no responda a este mensaje.</p>
