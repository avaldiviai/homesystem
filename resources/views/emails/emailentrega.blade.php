...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <h1>Entrega de Propiedad</h1>
        </div>
        
        <!-- Content Section -->
        <div class="email-content">
            <h3 class="section-title">Detalles de la Entrega</h3>

            <p><span class="highlight">Fecha de Entrega de la propiedad:</span> {{ $fecha_entrega }}</p>
        ...
        <div class="email-footer">
            <p>Este es un correo automático enviado para informar sobre la entrega de la propiedad al arrendatario. Por favor, no responda a este mensaje.</p>
