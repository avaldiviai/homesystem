                            ...
                            <div class="container-fluid text-white">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3 col-lg-4">
                                        ...
                                        <input type="date" class="form-control" placeholder="Reajuste IPC" id="reajusteInput" required>
                                    </div>
                                        ...
                                        <form id="formulario" class="container mt-4" style="display: none;">
                                            ...
                                            <div class="border p-3 rounded mb-lg-4">
                                                ...
                                                <div class="col-md-12 mb-3 position-relative">
                                                    ...
                                                    <input type="email" id="correo" class="form-control" name="correo" placeholder="Ej: nombre@gmail.com" required oninput="validarCorreo(this)">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <small id="errorProfesion" class="text-danger"></small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group mb-3">
    ...
    $('#guardarCambios').off().on('click', function(event) {
        event.preventDefault();
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $("#loadingOverlay").fadeIn(); // Mostrar overlay apenas empieza
                }
            })
            .done(function(response){
                ...
                // Cuando todo fue exitoso, ocultamos cargando
                $("#loadingOverlay").fadeOut(function() {
                    // Y recién después mostramos el modal
                    $("#successModal").modal('show');
            ...
            .fail(function(jqXHR, textStatus, errorThrown){
                console.log("Error:", errorThrown);
                $("#loadingOverlay").fadeOut(); // Ocultar en caso de error también
...
async function generarPDF() {
    ...
    Swal.fire({
        ...
        text: '¿Seguro de descargar el documento?',
