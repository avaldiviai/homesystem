                                    ...
                                    <div class="row g-2">
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex gap-2 mb-2">
                                                <select id="campo-seccion-subir" class="input-inline flex-grow-1" style="min-height:34px;"></select>
                                                <input type="text" id="nueva-seccion-input" class="input-inline" style="width:130px;" placeholder="Nueva sección...">
                                                <button type="button" id="btn-crear-seccion" class="btn-guardar-inline px-3"><i class="fas fa-plus"></i></button>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div id="drop-area" class="drop-area-inline">
                                                ...
                                                <input type="file" id="imagenes" multiple style="display:none;" accept="image/*">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="video-drop-area" class="drop-area-inline"
                                                ...
                                                <input type="file" name="videos" id="videos" accept="video/*" style="display:none;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end gap-2 mt-3">
                                        <button type="button" class="btn-cancelar-inline" onclick="cancelarEditFotos()">Cancelar</button>
                                        <button type="button" class="btn-guardar-inline" onclick="guardarSeccion('fotos')">
                            ...
                            <div class="card-seccion-body" id="body-arriendo">
                                ...
                                <div id="view-arriendo">
                                    ...
                                    <div class="fila-dato">
                                        ...
                                        <span class="valor-dato" id="disp-gastos-comunes">${{ number_format($arriendos->first()->gastos_comunes ?? 0, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="fila-dato">
                                        <span class="label-campo">Valor Real</span>
                                        <span class="valor-dato" id="disp-valor-real">${{ number_format($arriendos->first()->valor_real ?? 0, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="fila-dato">
                                        <span class="label-campo">Fecha Inicio</span>
                                        <span class="valor-dato" id="disp-fecha-inicio">{{ $arriendos->first()?->fecha_entrega ? \Carbon\Carbon::parse($arriendos->first()->fecha_entrega)->format('d/m/Y') : '—' }}</span>
                                    </div>
                                    <div class="fila-dato">
                                        <span class="label-campo">Próximo Reajuste</span>
                                        <span class="valor-dato" id="disp-proximo-reajuste">{{ $arriendos->first()?->fecha_reajuste ? \Carbon\Carbon::parse($arriendos->first()->fecha_reajuste)->format('d/m/Y') : '—' }}</span>
                                    </div>
                                    <div class="fila-dato">
                                        <span class="label-campo">Reajuste</span>
                                        <span class="valor-dato" style="font-size:.82rem; opacity:.75;">Cada 1 año automáticamente</span>
                                    </div>
                                </div>
                                ...
                                <div id="edit-arriendo" style="display:none;">
                                    <div class="fila-edit">
                                        ...
                                        <input type="number" id="m_valor_arriendo" class="input-inline resaltado" value="{{ $precios->ano_corrido ?? '' }}" placeholder="Ej: 450000">
                                    </div>
                                    <div class="fila-edit">
                                        <label class="label-campo">Gastos Comunes</label>
                                        <input type="text" id="m_gastos_comunes" class="input-inline" value="{{ $arriendos->first()?->gastos_comunes ? '$' . number_format($arriendos->first()->gastos_comunes, 0, ',', '.') : '' }}" placeholder="Ej: $150.000">
                                    </div>
                                    <div class="fila-edit">
                                        <label class="label-campo">Valor Real</label>
                                        <input type="text" id="m_valor_real" class="input-inline" value="{{ $arriendos->first()?->valor_real ? '$' . number_format($arriendos->first()->valor_real, 0, ',', '.') : '' }}" placeholder="Ej: $450.000">
                                    </div>
                                    <div class="fila-edit">
                                        <label class="label-campo">Fecha Inicio</label>
                                        <input type="date" id="m_fecha_inicio" class="input-inline" value="{{ $arriendos->first()?->fecha_entrega ? \Carbon\Carbon::parse($arriendos->first()->fecha_entrega)->format('Y-m-d') : '' }}">
                                    </div>
                                    <div class="fila-edit">
                                        <label class="label-campo">Próximo Reajuste</label>
                                        <input type="date" id="m_proximo_reajuste" class="input-inline" value="{{ $arriendos->first()?->fecha_reajuste ? \Carbon\Carbon::parse($arriendos->first()->fecha_reajuste)->format('Y-m-d') : '' }}">
                                    </div>
                                    <div class="d-flex justify-content-end gap-2 mt-3">
                                        <button type="button" class="btn-cancelar-inline" onclick="cancelarEdit('arriendo')">Cancelar</button>
                                        <button type="button" class="btn-guardar-inline" onclick="guardarSeccion('arriendo')">
                                            <i class="fas fa-save me-1"></i>Guardar
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="grupo-datos">
                                                ...
                                                <div class="fila-dato"><span class="label-campo">Propietario</span><span class="valor-dato">{{ $propietarios->first()->propietario->nombre ?? '—' }}</span></div>
                                                <div class="fila-dato"><span class="label-campo">Dirección</span><span class="valor-dato" id="disp-direccion">{{ $detalles->direccion }}</span></div>
                                                <div class="fila-dato"><span class="label-campo">Comuna</span><span class="valor-dato" id="disp-ciudad">{{ $detalles->ciudad }}</span></div>
                                                <div class="fila-dato"><span class="label-campo">Rol</span><span class="valor-dato" id="disp-rol">{{ $detalles->rol }}</span></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="grupo-datos">
                                                <p class="grupo-titulo">Servicios Básicos</p>
                                                <div class="fila-dato"><span class="label-campo">Empresa Luz</span><span class="valor-dato" id="disp-empresa-luz">{{ $detalles->empresa_luz ?? '—' }}</span></div>
                                                <div class="fila-dato"><span class="label-campo">N° Cliente Luz</span><span class="valor-dato" id="disp-numero-luz">{{ $detalles->numero_luz ?? '—' }}</span></div>
                                                <div class="fila-dato"><span class="label-campo">Empresa Agua</span><span class="valor-dato" id="disp-empresa-agua">{{ $detalles->empresa_agua ?? '—' }}</span></div>
                                                <div class="fila-dato"><span class="label-campo">N° Cliente Agua</span><span class="valor-dato" id="disp-numero-agua">{{ $detalles->numero_agua ?? '—' }}</span></div>
                                                <div class="fila-dato"><span class="label-campo">Empresa Gas</span><span class="valor-dato" id="disp-empresa-gas">{{ $detalles->empresa_gas ?? '—' }}</span></div>
                                                <div class="fila-dato"><span class="label-campo">N° Cliente Gas</span><span class="valor-dato" id="disp-numero-gas">{{ $detalles->numero_gas ?? '—' }}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex flex-wrap gap-2" id="lista-chips-propietarios">
                                            @foreach($propietarios as $prop)
                                                <span class="chip-propietario">
                                                    <i class="fa-solid fa-user-tie me-1"></i>{{ $prop->propietario->nombre }}
                                                    <a href="javascript:void(0)" data-id="{{$prop->id}}" class="delete-propietario ms-1" style="color:#f9a8a8;">
                                ...
                                <div id="edit-propiedad" style="display:none;">
                                    <div class="row g-2 mb-2">
                                        <div class="col-md-6">
                                            <div class="grupo-datos">
                                                <p class="grupo-titulo">Ubicación</p>
                                                <div class="fila-edit"><label class="label-campo">Dirección</label><input type="text" id="m_direccion" class="input-inline" value="{{ $detalles->direccion }}"></div>
                                                <div class="fila-edit"><label class="label-campo">Comuna</label><input type="text" id="m_ciudad" class="input-inline" value="{{ $detalles->ciudad }}"></div>
                                                <div class="fila-edit"><label class="label-campo">Rol</label><input type="text" id="m_rol" class="input-inline" value="{{ $detalles->rol }}"></div>
                                                <div class="fila-edit"><label class="label-campo">Tipo Vivienda</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="grupo-datos">
                                                <p class="grupo-titulo">Servicios Básicos</p>
                                                <div class="fila-edit"><label class="label-campo">Empresa Luz</label><input type="text" id="m_empresa_luz" class="input-inline" value="{{ $detalles->empresa_luz }}"></div>
                                                <div class="fila-edit"><label class="label-campo">N° Cliente Luz</label><input type="text" id="m_numero_luz" class="input-inline" value="{{ $detalles->numero_luz }}"></div>
                                                <div class="fila-edit"><label class="label-campo">Empresa Agua</label><input type="text" id="m_empresa_agua" class="input-inline" value="{{ $detalles->empresa_agua }}"></div>
                                                <div class="fila-edit"><label class="label-campo">N° Cliente Agua</label><input type="text" id="m_numero_agua" class="input-inline" value="{{ $detalles->numero_agua }}"></div>
                                                <div class="fila-edit"><label class="label-campo">Empresa Gas</label><input type="text" id="m_empresa_gas" class="input-inline" value="{{ $detalles->empresa_gas }}"></div>
                                                <div class="fila-edit"><label class="label-campo">N° Cliente Gas</label><input type="text" id="m_numero_gas" class="input-inline" value="{{ $detalles->numero_gas }}"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="grupo-datos">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <button type="button" class="btn-guardar-inline px-3" onclick="agregarPropietarioInline()">Agregar</button>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end gap-2 mt-3">
                                        <button type="button" class="btn-cancelar-inline" onclick="cancelarEdit('propiedad')">Cancelar</button>
                                        <button type="button" class="btn-guardar-inline" onclick="guardarSeccion('propiedad')">
                                            <i class="fas fa-save me-1"></i>Guardar
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="card-seccion-body">
                                ...
                                <div id="view-caracteristicas">
                                    <div class="d-flex flex-wrap gap-2 mb-3">
                                        <div class="chip-num"><i class="fas fa-bed"></i><span id="disp-dorm">{{ $detallespropiedad->dormitorios ?? '—' }}</span><small>Dorm.</small></div>
                                        <div class="chip-num"><i class="fas fa-bath"></i><span id="disp-banos">{{ $detallespropiedad->banos ?? '—' }}</span><small>Baños</small></div>
                                        <div class="chip-num"><i class="fas fa-ruler-combined"></i><span id="disp-mt2">{{ $detallespropiedad->mt2_total ?? '—' }}</span><small>m²</small></div>
                                        <div class="chip-num"><i class="fas fa-car"></i><span id="disp-est">{{ $sub_est->estacionamiento ?? '—' }}</span><small>Est.</small></div>
                                        <div class="chip-num"><i class="fas fa-box"></i><span id="disp-bodega">{{ $sub_bodega->bodega ?? '—' }}</span><small>Bodega</small></div>
                                    </div>
                                    <div class="fila-dato"><span class="label-campo">Vivienda</span><span class="valor-dato" id="disp-vivienda">{{ $detalles->tipo_vivienda ?? '—' }}</span></div>
                                    <div class="fila-dato">
                                    ...
                                    <div class="fila-dato"><span class="label-campo">Elementos Entregados</span><span class="valor-dato" id="disp-elementos">{{ $detallespropiedad->elementos_entregados ?? '—' }}</span></div>
                                    ...
                                    <div class="mt-2 p-2 rounded" id="disp-obs-wrap" style="background:rgba(0,0,0,.2); font-size:.83rem; color:#fff;">
                                        ...
                                        <span id="disp-observaciones">{{ $detallespropiedad->observaciones }}</span>
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div id="edit-caracteristicas" style="display:none;">
                                    <div class="row g-2 mb-2">
                                        <div class="col-4"><label class="label-campo">Dormitorios</label><input type="text" id="m_dormitorios" class="input-inline text-center" value="{{ $detallespropiedad->dormitorios }}"></div>
                                        <div class="col-4"><label class="label-campo">Baños</label><input type="text" id="m_banos" class="input-inline text-center" value="{{ $detallespropiedad->banos }}"></div>
                                        <div class="col-4"><label class="label-campo">m² Total</label><input type="text" id="m_mt2" class="input-inline text-center" value="{{ $detallespropiedad->mt2_total }}"></div>
                                        <div class="col-4"><label class="label-campo">Estacionamiento</label><input type="text" id="m_est" class="input-inline text-center" value="{{ $sub_est->estacionamiento }}"></div>
                                        <div class="col-4"><label class="label-campo">N° Bodega</label><input type="text" id="m_bodega" class="input-inline text-center" value="{{ $sub_bodega->bodega }}"></div>
                                    ...
                                    <div class="fila-edit">
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            <input type="radio" class="btn-check" name="m_am_op" id="m_am_si" {{ ($detallespropiedad->amoblado ?? '') == 'si' ? 'checked' : '' }}>
                                            <label class="btn btn-outline-light btn-sm" for="m_am_si">SÍ</label>
                                            <input type="radio" class="btn-check" name="m_am_op" id="m_am_no" {{ ($detallespropiedad->amoblado ?? 'no') != 'si' ? 'checked' : '' }}>
                                    ...
                                    <div class="fila-edit mt-2">
                                        ...
                                        <input type="text" id="m_elementos" class="input-inline" value="{{ $detallespropiedad->elementos_entregados ?? '' }}">
                                    </div>
                                    <div class="mt-2">
                                    ...
                                    <div class="d-flex justify-content-end gap-2 mt-3">
                                        <button type="button" class="btn-cancelar-inline" onclick="cancelarEdit('caracteristicas')">Cancelar</button>
                                        <button type="button" class="btn-guardar-inline" onclick="guardarSeccion('caracteristicas')">
                                            <i class="fas fa-save me-1"></i>Guardar
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="card-seccion" id="card-arrendatario">
                            <div class="card-seccion-header">
                                ...
                                <div class="btns-accion">
                                    <button class="btn-edit" onclick="toggleEdit('arrendatario')" id="btn-edit-arrendatario" title="Editar"><i class="fas fa-pen"></i></button>
                                    <button class="btn-del" onclick="confirmarEliminar('arrendatario')" title="Eliminar"><i class="fas fa-trash-alt"></i></button>
                                </div>
                            </div>
                            <div class="card-seccion-body">
                                ...
                                <div id="view-arrendatario">
                                    <div class="row g-2">
                                        <div class="col-md-2 col-6"><span class="label-campo">Nombre</span><p class="valor-dato-lg" id="disp-arr-nombre">{{ $arrendatario->nombre ?? '—' }}</p></div>
                                        <div class="col-md-2 col-6"><span class="label-campo">RUT</span><p class="valor-dato-lg" id="disp-arr-rut">{{ $arrendatario->rut ?? '—' }}</p></div>
                                ...
                                <div id="edit-arrendatario" style="display:none;">
                                    <div class="row g-2">
                                        <div class="col-md-4 col-6">
                                            ...
                                            <input type="text" id="m_nombre_arr" class="input-inline" value="{{ $arrendatario->nombre ?? '' }}">
                                        </div>
                                        <div class="col-md-4 col-6">
                                            <label class="label-campo">RUT</label>
                                            <input type="text" id="m_rut_arr" class="input-inline" value="{{ $arrendatario->rut ?? '' }}" placeholder="12.345.678-9">
                                        </div>
                                        <div class="col-md-4 col-6">
                                            <label class="label-campo">Teléfono</label>
                                            <input type="text" id="m_tel_arr" class="input-inline" value="{{ $arrendatario->telefono ?? '' }}">
                                        </div>
                                        <div class="col-md-4 col-6">
                                            <label class="label-campo">Correo</label>
                                            <input type="email" id="m_correo_arr" class="input-inline" value="{{ $arrendatario->correo ?? '' }}">
                                        </div>
                                        <div class="col-md-4 col-6">
                                    ...
                                    <div class="mt-3 pt-2" style="border-top:1px solid rgba(255,255,255,.15);">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                ...
                                                <input type="file" id="m_info_cliente" class="input-inline" style="padding:.2rem .4rem;">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="label-campo">Contratos / Acta / Inventario</label>
                                                <input type="file" id="m_docs_arr" class="input-inline" style="padding:.2rem .4rem;" multiple>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end gap-2 mt-3">
                                        <button type="button" class="btn-cancelar-inline" onclick="cancelarEdit('arrendatario')">Cancelar</button>
                                        <button type="button" class="btn-guardar-inline" onclick="guardarSeccion('arrendatario')">
                                            <i class="fas fa-save me-1"></i>Guardar
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-5">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="tipo_trabajo" class="input-mantenimiento" placeholder="Ej: Calefón, Caldera, Pintura...">
                                            </div>
                                            <div class="mb-3">
                                                <label class="label-mantenimiento">Fecha de Mantención</label>
                                                <input type="date" id="fecha_mantencion_nueva" class="input-mantenimiento">
                                            </div>
                                            <div class="mb-3">
                                                <label class="label-mantenimiento">Persona a Cargo</label>
                                                <input type="text" id="persona_cargo_nueva" class="input-mantenimiento" placeholder="Ej: Juan Pérez">
                                            </div>
                                            <div class="mb-3">
                                                <label class="label-mantenimiento">Próxima Mantención</label>
                                                <input type="date" id="proxima_mantencion_nueva" class="input-mantenimiento">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                <label class="label-mantenimiento">Descripción del trabajo</label>
                                                <textarea rows="7" id="descripcion_trabajo_nueva" class="input-mantenimiento" placeholder="Detalle del trabajo realizado..."></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label class="label-mantenimiento">Archivo (doc/pdf)</label>
                                                <input type="file" id="archivo_trabajo" class="archivo-mantenimiento">
                                            </div>
                                            <div class="mb-3">
                                                <label class="label-mantenimiento">Fotos</label>
                                                <input type="file" multiple id="fotos_trabajo" class="archivo-mantenimiento" accept="image/*">
                                            </div>
                                            <div class="mb-3">
                                                <label class="label-mantenimiento">Videos</label>
                                                <input type="file" multiple id="videos_trabajo" class="archivo-mantenimiento" accept="video/*">
                                            </div>
                                            <div class="d-flex justify-content-end mt-2">
                                                <button type="button" id="btn_agregar_trabajo" class="btn-guardar-inline">
...
@if(isset($trabajos) && $trabajos->count() > 0)
    <p class="label-campo mb-3" style="font-size:.8rem; opacity:.75; letter-spacing:.5px;">
        ...
        <div class="col-lg-4 col-md-6" id="card-trabajo-{{ $t->id }}">
            <div class="card-trabajo">
                ...
                <div id="view-trabajo-{{ $t->id }}">
                    ...
                    <div style="border-top:1px solid rgba(255,255,255,.15); padding-top:.6rem; margin-bottom:.6rem;">
                        @if($t->persona_cargo)
                        <div class="fila-dato">
                            <span class="label-campo"><i class="fas fa-user me-1"></i>Persona a Cargo</span>
                            <span class="valor-dato">{{ $t->persona_cargo }}</span>
                        </div>
                        @endif
                        @if($t->fecha_prox_man)
                        <div class="fila-dato">
                            <span class="label-campo"><i class="fas fa-clock me-1"></i>Próxima Mantención</span>
                    ...
                    @if($t->doc)
                    <div class="mb-2">
                        <a href="{{ asset($t->doc) }}" target="_blank" class="trabajo-adjunto">
                    ...
                    <div class="d-flex gap-2 mt-2">
                        <button type="button" class="btn-guardar-inline flex-fill"
                ...
                <div id="edit-trabajo-{{ $t->id }}" style="display:none;">
                    <div class="mb-2">
                        ...
                        <input type="text" id="edit-tipo-{{ $t->id }}" class="input-inline" value="{{ $t->nombre }}">
                    </div>
                    <div class="mb-2">
                        <label class="label-campo">Fecha Mantención</label>
                        <input type="date" id="edit-fecha-{{ $t->id }}" class="input-inline"
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="edit-persona-{{ $t->id }}" class="input-inline" value="{{ $t->persona_cargo }}">
                    </div>
                    <div class="mb-2">
                        <label class="label-campo">Próxima Mantención</label>
                        <input type="date" id="edit-proxima-{{ $t->id }}" class="input-inline"
                            value="{{ $t->fecha_prox_man ? \Carbon\Carbon::parse($t->fecha_prox_man)->format('Y-m-d') : '' }}">
                    </div>
                    <div class="mb-2">
                        <label class="label-campo">Descripción</label>
                        <textarea id="edit-desc-{{ $t->id }}" class="input-inline" rows="3"
                            style="resize:none;">{{ $t->descripcion }}</textarea>
                    </div>
                    <div class="mb-2">
                        <label class="label-campo">Documento (opcional)</label>
                        <input type="file" id="edit-doc-{{ $t->id }}" class="input-inline" style="padding:.2rem .4rem;">
                    </div>
                    <div class="d-flex gap-2 mt-2">
                        <button type="button" class="btn-cancelar-inline flex-fill"
...
@else
    <div class="text-center py-4" style="color:rgba(255,255,255,.4); font-size:.88rem;">
...
<div id="modal-reasignar" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.6); z-index:9999; align-items:center; justify-content:center;">
    <div class="bg-white rounded p-4 shadow" style="max-width:340px; width:90%;">
        ...
        <img id="modal-preview-img" src="" class="rounded w-100 mb-3" style="height:140px; object-fit:cover;">
        <select id="modal-select-seccion" class="form-select form-select-sm mb-3"></select>
        <div class="d-flex gap-2">
            <button type="button" id="modal-btn-confirmar" class="btn btn-dark btn-sm rounded-pill flex-fill">Guardar</button>
            <button type="button" id="modal-btn-cancelar" class="btn btn-outline-secondary btn-sm rounded-pill flex-fill">Cancelar</button>
        </div>
    </div>
</div>

{{-- Loading overlay --}}
<div id="loadingOverlay" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.5); z-index:99999; align-items:center; justify-content:center;">
...
$(document).ready(function () {
    ...
    $('#btn_agregar_trabajo').on('click', function () {
        ...
        .fail(function (xhr) {
            var msg = xhr.responseJSON && xhr.responseJSON.message ? xhr.responseJSON.message : 'Error al guardar el trabajo.';
            mostrarError(msg);
        });
    });
    ...
    $(document).on('click', '.delete-img', function(e) {
        ...
        $.ajax({ url: '/imagen/' + idImg, type: 'DELETE' })
        .done(function() {
    ...
    $(document).on('click', '.portada', function(e) {
        ...
        $.ajax({ url: '/portada/cambiar_img/' + idImg, type: 'POST' })
    ...
    $(document).on('click', '.delete-video', function(e) {
        ...
        $.ajax({ url: '/video/' + idVideo, type: 'DELETE' })
        .done(function() { $wrap.remove(); })
    ...
    $(document).on('click', '.delete-propietario', function(e) {
        ...
        $.ajax({ url: '/propietarioDelete/' + idPropietario, type: 'DELETE' })
        .done(function() { $chip.remove(); })
...
function agregarPropietarioInline() {
    ...
    if (!id || id === '0') return;
    _propietariosNuevos.push({ id: id });
...
function bindDropAreaInline() {
    ...
    fileInput.onchange = function() { handleFilesInline(fileInput.files, preview); };
    dropArea.ondragover = function(e) { e.preventDefault(); dropArea.style.background='rgba(0,0,0,.25)'; };
    dropArea.ondragleave = function() { dropArea.style.background=''; };
    dropArea.ondrop = function(e) { e.preventDefault(); dropArea.style.background=''; handleFilesInline(e.dataTransfer.files, preview); };
    var videoDrop = document.getElementById('video-drop-area');
    if (videoDrop) videoDrop.onclick = function(){ document.getElementById('videos').click(); };
}
...
function guardarSeccion(seccion) {
   ...
   $.ajax({
    ...
    .done(function(resp) {
        ...
        setTimeout(function() { ocultarLoading(); }, 1500);
    })
    .fail(function(xhr) {
...
function confirmarEliminar(seccion) {
    ...
    if (confirm('¿Seguro/a que deseas eliminar ' + (nombres[seccion] || seccion) + '? Esta acción no se puede deshacer.')) {
...
function eliminarTrabajo(id) {
    ...
    .done(function() {
        ...
        setTimeout(function() {
            ocultarLoading();
            $('#card-trabajo-' + id).fadeOut(300, function() { $(this).remove(); });
        }, 1000);
    })
    .fail(function() {
...
/* ── BOTONES ACCIÓN ── */
.btns-accion { display:flex; gap:.4rem; }
.btn-edit, .btn-del {
...
.btn-edit { background:rgba(255,255,255,.2); color:#fff; }
.btn-del  { background:rgba(220,50,50,.35);  color:#ffe5e5; }
.btn-edit:hover { background:rgba(255,255,255,.4); transform:scale(1.1); }
.btn-del:hover  { background:rgba(220,50,50,.6);  transform:scale(1.1); }
...
.fila-dato {
    ...
    padding:.3rem 0; border-bottom:1px solid rgba(255,255,255,.2);
...
.fila-edit {
    ...
    padding:.3rem 0; border-bottom:1px solid rgba(255,255,255,.2);
    font-size:.87rem; gap:.6rem;
}
.fila-edit:last-child { border-bottom:none; }

/* ── VALORES ── */
.valor-dato    { color:#fff; font-weight:600; text-align:right; }
.valor-dato-lg { color:#fff; font-weight:600; font-size:.9rem; margin:0; }
.valor-dato.resaltado { font-size:1.1rem; font-weight:800; }
...
.input-inline {
    ...
    padding:.3rem .6rem; width:100%;
    outline:none; min-height:34px;
    transition:box-shadow .15s;
}
.input-inline:focus { box-shadow:0 0 0 2px #000; }
.input-inline.resaltado { font-size:1rem; font-weight:800; }
select.input-inline { cursor:pointer; }
textarea.input-inline { resize:none; }
...
.btn-guardar-inline:hover { opacity:.8; }
.btn-cancelar-inline {
...
.btn-cancelar-inline:hover { background:rgba(255,255,255,.35); }
...
.chip-num {
    ...
    background:rgba(0,0,0,.2); border:1.5px solid rgba(255,255,255,.3);
    border-radius:.5rem; padding:.4rem .6rem; min-width:58px;
    font-size:.75rem; color:#fff;
}
.chip-num i     { color:#fff; font-size:.85rem; margin-bottom:2px; opacity:.8; }
.chip-num span  { font-weight:700; font-size:1rem; line-height:1; }
.chip-num small { color:rgba(255,255,255,.7); font-size:.68rem; }
...
.badge-si { background:rgba(0,0,0,.3); color:#a8f0c6; font-size:.78rem; font-weight:700; padding:2px 8px; border-radius:50px; }
.badge-no { background:rgba(0,0,0,.3); color:#f9a8a8; font-size:.78rem; font-weight:700; padding:2px 8px; border-radius:50px; }

/* ── TABS IMÁGENES ── */
.tab-sec {
    background:rgba(0,0,0,.2); border:1.5px solid rgba(255,255,255,.3);
    border-radius:50px; padding:2px 10px; font-size:.75rem;
    color:#fff; cursor:pointer; transition:all .15s;
}
.tab-sec:hover  { background:rgba(0,0,0,.35); }
.tab-sec-activo { background:#000; border-color:#000; color:#fff !important; font-weight:700; }
...
.miniatura-recorrido:hover { border-color:#fff !important; opacity:.9; }
#strip-miniaturas::-webkit-scrollbar { height:4px; }
#strip-miniaturas::-webkit-scrollbar-thumb { background:rgba(255,255,255,.3); border-radius:10px; }

/* ── BADGE ORDEN ── */
.badge-orden {
    font-size:.72rem; background:rgba(0,0,0,.2); color:#fff;
    border:1px solid rgba(255,255,255,.3); border-radius:50px;
    padding:2px 9px; cursor:pointer; transition:background .15s; user-select:none;
}
.badge-orden:hover, .badge-orden.activo { background:rgba(0,0,0,.45); }

/* ── BOTÓN ARCHIVO ── */
.btn-archivo {
    background:rgba(0,0,0,.2); border:1.5px solid rgba(255,255,255,.35);
    color:#fff; border-radius:50px; padding:.3rem .9rem;
    font-size:.8rem; font-weight:600; cursor:pointer; transition:background .15s;
}
.btn-archivo:hover { background:rgba(0,0,0,.4); }

/* ── BOTÓN ELIMINAR FLOTANTE ── */
.btn-eliminar-flotante {
    position:absolute; top:10px; right:10px;
    background:rgba(255,255,255,.85); color:#c0392b;
    padding:7px 9px; border-radius:.4rem; font-size:.85rem;
}

/* ── DROP AREA ── */
.drop-area-inline {
    border:2px dashed rgba(255,255,255,.5); border-radius:.5rem;
    padding:.8rem; text-align:center; color:rgba(255,255,255,.8);
    font-size:.83rem; cursor:pointer; min-height:70px;
    display:flex; flex-direction:column; align-items:center; justify-content:center;
    transition:background .15s;
}
.drop-area-inline:hover { background:rgba(0,0,0,.15); }
...
.input-mantenimiento {
    ...
    background:#fff; color:var(--negro);
    font-weight:600; font-size:.85rem;
    padding:.3rem .6rem; width:100%; min-height:36px; outline:none;
}
.input-mantenimiento:focus { box-shadow:0 0 0 2px #000; }
textarea.input-mantenimiento { resize:none; min-height:150px; }
.archivo-mantenimiento {
    background:#fff; color:var(--negro);
    border:none; border-radius:.5rem; font-size:.83rem; width:100%;
}
...
.card-trabajo:hover { background:rgba(0,0,0,.3); }
...
.trabajo-adjunto:hover { background:rgba(0,0,0,.5); color:#fff; }
